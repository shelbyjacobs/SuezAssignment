This uses a REST endpoint to get an csv of people, sort them alphabetically by name, and then put the sorted users back to the endpoint in the form of a json.
